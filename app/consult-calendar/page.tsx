...
import "@/public/assets/css/pages/consult-calendar.css";
...
export const metadata: Metadata = {
  "title": "Schedule Your Consultation with Credit Danny",
  "description": "Book your private strategy session with Credit Danny. Pick a date and time that works for you and get a full review of your credit profile.",
  "robots": "nofollow, noindex",
  "alternates": {
    "canonical": "https://creditdanny.com/consult-calendar/"
  },
  "openGraph": {
    "locale": "en_US",
    "type": "article",
    "title": "Schedule Your Consultation with Credit Danny",
    "description": "Book your private strategy session with Credit Danny. Pick a date and time that works for you and get a full review of your credit profile.",
    "url": "https://creditdanny.com/consult-calendar/",
    ...
    "images": [
      {
        ...
        "width": 1200,
        "height": 630,
        "alt": "Schedule Consultation with Credit Danny",
        "type": "image/jpeg"
      }
    ],
    "publishedTime": "2026-08-12T22:00:32-07:00"
  },
  "twitter": {
...
export default function ConsultCalendarPage() {
  return (
    <>
      <BodyClass className="wp-singular page-template page-template-page-consult-calendar page-template-page-consult-calendar-php page page-id-27270427 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor cd-consult-calendar eio-default hello-elementor-default elementor-default elementor-kit-27255861" />
      <meta name="twitter:label1" content="Time to read" />
      <meta name="twitter:data1" content="Less than a minute" />
      <meta name="ti-site-data" content="eyJyIjoiMTowITc6MCEzMDowIiwibyI6Imh0dHBzOlwvXC9jcmVkaXRkYW5ueS5jb20/dGktb25saW5lLXVzZXJzLWdvb2dsZT0xJmFtcDtwPSUyRmNvbnN1bHQtY2FsZW5kYXIlMkYmYW1wO193cG5vbmNlPWJmODI1MTM5NGIifQ==" />
      <meta name="msapplication-TileImage" content="assets/img/heartfavicon-300x300.png" />
      <script type="application/ld+json" className="rank-math-schema" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@graph\":[{\"@type\":[\"Person\",\"Organization\"],\"@id\":\"https://creditdanny.com/#person\",\"name\":\"Credit Danny\",\"sameAs\":[\"https://www.instagram.com/creditdanny/\",\"https://www.tiktok.com/@creditdanny\"],\"logo\":{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/#logo\",\"url\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"contentUrl\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"caption\":\"Credit Danny\",\"inLanguage\":\"en-US\",\"width\":\"1394\",\"height\":\"261\"},\"image\":{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/#logo\",\"url\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"contentUrl\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"caption\":\"Credit Danny\",\"inLanguage\":\"en-US\",\"width\":\"1394\",\"height\":\"261\"}},{\"@type\":\"WebSite\",\"@id\":\"https://creditdanny.com/#website\",\"url\":\"https://creditdanny.com\",\"name\":\"Credit Danny\",\"alternateName\":\"Elevate Financial Services\",\"publisher\":{\"@id\":\"https://creditdanny.com/#person\"},\"inLanguage\":\"en-US\"},{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\",\"url\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\",\"width\":\"1200\",\"height\":\"630\",\"inLanguage\":\"en-US\"},{\"@type\":\"BreadcrumbList\",\"@id\":\"https://creditdanny.com/consult-calendar/#breadcrumb\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":\"1\",\"item\":{\"@id\":\"https://creditdanny.com\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":\"2\",\"item\":{\"@id\":\"https://creditdanny.com/consult-calendar/\",\"name\":\"Schedule Consultation with Credit Danny\"}}]},{\"@type\":\"WebPage\",\"@id\":\"https://creditdanny.com/consult-calendar/#webpage\",\"url\":\"https://creditdanny.com/consult-calendar/\",\"name\":\"Schedule Your Consultation with Credit Danny\",\"datePublished\":\"2026-08-12T22:00:32-07:00\",\"dateModified\":\"2026-08-12T22:00:32-07:00\",\"isPartOf\":{\"@id\":\"https://creditdanny.com/#website\"},\"primaryImageOfPage\":{\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\"},\"inLanguage\":\"en-US\",\"breadcrumb\":{\"@id\":\"https://creditdanny.com/consult-calendar/#breadcrumb\"}},{\"@type\":\"Person\",\"@id\":\"https://creditdanny.com/author/\",\"url\":\"https://creditdanny.com/author/\",\"image\":{\"@type\":\"ImageObject\",\"@id\":\"https://secure.gravatar.com/avatar/?s=96&amp;d=mm&amp;r=g\",\"url\":\"https://secure.gravatar.com/avatar/?s=96&amp;d=mm&amp;r=g\",\"inLanguage\":\"en-US\"}},{\"@type\":\"Article\",\"headline\":\"Schedule Your Consultation with Credit Danny\",\"datePublished\":\"2026-08-12T22:00:32-07:00\",\"dateModified\":\"2026-08-12T22:00:32-07:00\",\"author\":{\"@id\":\"https://creditdanny.com/author/\"},\"publisher\":{\"@id\":\"https://creditdanny.com/#person\"},\"description\":\"Book your private strategy session with Credit Danny. Pick a date and time that works for you and get a full review of your credit profile.\",\"name\":\"Schedule Your Consultation with Credit Danny\",\"@id\":\"https://creditdanny.com/consult-calendar/#richSnippet\",\"isPartOf\":{\"@id\":\"https://creditdanny.com/consult-calendar/#webpage\"},\"image\":{\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\"},\"inLanguage\":\"en-US\",\"mainEntityOfPage\":{\"@id\":\"https://creditdanny.com/consult-calendar/#webpage\"}}]}" }} />
      <Script src="https://link.msgsndr.com/js/form_embed.js" type="text/javascript" strategy="afterInteractive" />
      ...
      <SharedHeaderTop />
      <div id="cc-page" style={{ "fontFamily": "var(--font-body)", "color": "#000", "overflowX": "hidden" }}>
        <div style={{ "position": "relative", "background": "#000", "backgroundImage": "radial-gradient(ellipse 128% 116% at 0% 100%,#0C70C3 0%,#0b62ab 8%,#09508c 16%,#08406e 25%,#062846 34%,#03192a 46%,#010a12 60%,#000000 76%)", "overflow": "hidden" }}>
          <div style={{ "position": "absolute", "inset": "0", "pointerEvents": "none", "mixBlendMode": "screen", "backgroundImage": "linear-gradient(rgba(120,190,255,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(120,190,255,.05) 1px,transparent 1px),linear-gradient(rgba(120,190,255,.09) 1px,transparent 1px),linear-gradient(90deg,rgba(120,190,255,.09) 1px,transparent 1px)", "backgroundSize": "24px 24px,24px 24px,120px 120px,120px 120px" }} />
          <div style={{ "position": "relative", "maxWidth": "1320px", "margin": "0 auto", "padding": "40px 48px 45px", "display": "flex", "flexDirection": "column", "alignItems": "center", "textAlign": "center" }}>
            <div className="cc-eyebrow" style={{ "display": "inline-flex", "alignItems": "center", "gap": "10px", "padding": "8px 16px", "border": "1px solid #ffffff", "borderRadius": "999px", "background": "rgba(25,25,25,.4)", "backdropFilter": "blur(24px)", "WebkitBackdropFilter": "blur(24px)" }}>
              {" "}
              <span style={{ "width": "6px", "height": "6px", "borderRadius": "50%", "background": "var(--color-blue-400)", "boxShadow": "0 0 6px 2px rgba(0,173,238,.75),0 0 14px 4px rgba(0,173,238,.4)" }} />
              {" "}
              <span style={{ "fontSize": "11px", "fontWeight": "700", "letterSpacing": ".28em", "textTransform": "uppercase", "color": "#ffffff" }}>
                {"Private Strategy Session"}
              </span>
              {" "}
            </div>
            <h1 style={{ "fontFamily": "var(--font-display)", "fontWeight": "750", "textTransform": "uppercase", "fontSize": "clamp(40px,4.6vw,72px)", "lineHeight": "0.98", "color": "#fff", "margin": "24px 0 0", "textWrap": "balance" }}>
            ...
            <div className="cc-steps" style={{ "display": "grid", "gridTemplateColumns": "repeat(3,1fr)", "gap": "18px", "marginTop": "48px", "width": "100%", "textAlign": "left" }}>
              <div style={{ "background": "rgba(25,25,25,.4)", "backdropFilter": "blur(24px)", "WebkitBackdropFilter": "blur(24px)", "border": "1px solid rgba(255,255,255,.25)", "borderRadius": "25px", "padding": "28px 30px" }}>
                <div style={{ "fontFamily": "var(--font-stat)", "fontSize": "38px", "lineHeight": "1", "color": "var(--color-blue-400)" }}>
                  {"01"}
                </div>
                <div style={{ "fontSize": "17px", "lineHeight": "1.55", "color": "#fff", "marginTop": "10px", "textWrap": "pretty" }}>
              ...
              <div style={{ "background": "rgba(25,25,25,.4)", "backdropFilter": "blur(24px)", "WebkitBackdropFilter": "blur(24px)", "border": "1px solid rgba(255,255,255,.25)", "borderRadius": "25px", "padding": "28px 30px" }}>
                ...
                <div style={{ "fontSize": "17px", "lineHeight": "1.55", "color": "#fff", "marginTop": "10px", "textWrap": "pretty" }}>
                  <strong style={{ "fontWeight": "700" }}>
                    {"Can't find a date? Click the right arrow"}
                  </strong>
                  {" for next month."}
                </div>
              </div>
            ...
            {" "}
            <iframe loading="lazy" src="https://api.leadconnectorhq.com/widget/booking/UkK7NwZUkB2g2Ftxcgx3" style={{ "width": "100%", "height": "760px", "marginTop": "0", "border": "none", "overflow": "hidden", "borderRadius": "25px", "display": "block" }} scrolling="no" id="UkK7NwZUkB2g2Ftxcgx3_1739856142147" title="Book a consultation with Credit Danny" />
            {" "}
          </div>
        </div>
      </div>
