...
import "@/public/assets/css/pages/team.css";
...
export const metadata: Metadata = {
  "title": "Meet the Team | The People Behind Every Result | Credit Danny",
  "description": "The people behind every credit transformation, every victory and every client success story at Credit Danny and Elevate Financial Services.",
  "robots": "nofollow, noindex",
  "alternates": {
    "canonical": "https://creditdanny.com/team/"
  },
  "openGraph": {
    "locale": "en_US",
    "type": "article",
    "title": "Meet the Team | The People Behind Every Result | Credit Danny",
    "description": "The people behind every credit transformation, every victory and every client success story at Credit Danny and Elevate Financial Services.",
    "url": "https://creditdanny.com/team/",
    ...
    "publishedTime": "2026-08-12T08:34:10-07:00"
  },
  "twitter": {
...
export default function TeamPage() {
  return (
    <>
      <BodyClass className="wp-singular page-template page-template-page-team page-template-page-team-php page page-id-27270420 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor cd-team eio-default hello-elementor-default elementor-default elementor-kit-27255861" />
      <meta name="twitter:label1" content="Time to read" />
      <meta name="twitter:data1" content="Less than a minute" />
      <meta name="ti-site-data" content="eyJyIjoiMTowITc6MCEzMDowIiwibyI6Imh0dHBzOlwvXC9jcmVkaXRkYW5ueS5jb20/dGktb25saW5lLXVzZXJzLWdvb2dsZT0xJmFtcDtwPSUyRnRlYW0lMkYmYW1wO193cG5vbmNlPWJmODI1MTM5NGIifQ==" />
      <meta name="msapplication-TileImage" content="assets/img/heartfavicon-300x300.png" />
      <script type="application/ld+json" className="rank-math-schema" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@graph\":[{\"@type\":[\"Person\",\"Organization\"],\"@id\":\"https://creditdanny.com/#person\",\"name\":\"Credit Danny\",\"sameAs\":[\"https://www.instagram.com/creditdanny/\",\"https://www.tiktok.com/@creditdanny\"],\"logo\":{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/#logo\",\"url\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"contentUrl\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"caption\":\"Credit Danny\",\"inLanguage\":\"en-US\",\"width\":\"1394\",\"height\":\"261\"},\"image\":{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/#logo\",\"url\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"contentUrl\":\"https://creditdanny.com/wp-content/uploads/2025/03/credit-danny-logo-black2.png\",\"caption\":\"Credit Danny\",\"inLanguage\":\"en-US\",\"width\":\"1394\",\"height\":\"261\"}},{\"@type\":\"WebSite\",\"@id\":\"https://creditdanny.com/#website\",\"url\":\"https://creditdanny.com\",\"name\":\"Credit Danny\",\"alternateName\":\"Elevate Financial Services\",\"publisher\":{\"@id\":\"https://creditdanny.com/#person\"},\"inLanguage\":\"en-US\"},{\"@type\":\"ImageObject\",\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\",\"url\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\",\"width\":\"1200\",\"height\":\"630\",\"inLanguage\":\"en-US\"},{\"@type\":\"BreadcrumbList\",\"@id\":\"https://creditdanny.com/team/#breadcrumb\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":\"1\",\"item\":{\"@id\":\"https://creditdanny.com\",\"name\":\"Home\"}},{\"@type\":\"ListItem\",\"position\":\"2\",\"item\":{\"@id\":\"https://creditdanny.com/team/\",\"name\":\"Meet the Team\"}}]},{\"@type\":\"WebPage\",\"@id\":\"https://creditdanny.com/team/#webpage\",\"url\":\"https://creditdanny.com/team/\",\"name\":\"Meet the Team | The People Behind Every Result | Credit Danny\",\"datePublished\":\"2026-08-12T08:34:10-07:00\",\"dateModified\":\"2026-08-12T08:34:10-07:00\",\"isPartOf\":{\"@id\":\"https://creditdanny.com/#website\"},\"primaryImageOfPage\":{\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\"},\"inLanguage\":\"en-US\",\"breadcrumb\":{\"@id\":\"https://creditdanny.com/team/#breadcrumb\"}},{\"@type\":\"Person\",\"@id\":\"https://creditdanny.com/author/\",\"url\":\"https://creditdanny.com/author/\",\"image\":{\"@type\":\"ImageObject\",\"@id\":\"https://secure.gravatar.com/avatar/?s=96&amp;d=mm&amp;r=g\",\"url\":\"https://secure.gravatar.com/avatar/?s=96&amp;d=mm&amp;r=g\",\"inLanguage\":\"en-US\"}},{\"@type\":\"Article\",\"headline\":\"Meet the Team | The People Behind Every Result | Credit Danny\",\"datePublished\":\"2026-08-12T08:34:10-07:00\",\"dateModified\":\"2026-08-12T08:34:10-07:00\",\"author\":{\"@id\":\"https://creditdanny.com/author/\"},\"publisher\":{\"@id\":\"https://creditdanny.com/#person\"},\"description\":\"The people behind every credit transformation, every victory and every client success story at Credit Danny and Elevate Financial Services.\",\"name\":\"Meet the Team | The People Behind Every Result | Credit Danny\",\"@id\":\"https://creditdanny.com/team/#richSnippet\",\"isPartOf\":{\"@id\":\"https://creditdanny.com/team/#webpage\"},\"image\":{\"@id\":\"https://creditdanny.com/wp-content/uploads/2026/01/creditdanny_ogimg.jpg\"},\"inLanguage\":\"en-US\",\"mainEntityOfPage\":{\"@id\":\"https://creditdanny.com/team/#webpage\"}}]}" }} />
      ...
      <div className="cd-band">
        {" "}
        <img className="cd-band-hex" src="/assets/img/hex-pattern.svg" alt="" loading="lazy" decoding="async" aria-hidden="true" />
        {" "}
        <div className="cd-band-inner">
          ...
          <p className="cd-lede">
            {"The people behind every credit transformation, every\n      victory, and every client success story."}
          </p>
        </div>
      </div>
      <div className="cd-sec">
        <div className="cd-sec-inner">
          <div className="cd-people">
            <div className="cd-person cd-person--founder">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-danny.webp" alt="Credit Danny" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
          ...
          <p className="cd-tier cd-tier--sep">
            {"Executive Assistants"}
          </p>
          <div className="cd-people cd-people--row">
            <div className="cd-person cd-person--assistant">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-tuyen.webp" alt="Tuyen Gonzalez" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
                ...
                {" "}
                <span className="cd-email-line">
                  <a className="cd-email" href="mailto:tuyen@creditdanny.com">
                    {"tuyen@creditdanny.com"}
                  </a>
                </span>
                {" "}
                <p className="cd-role">
                  {"Executive Assistant to Credit Danny"}
                </p>
              </div>
            </div>
            <div className="cd-person cd-person--assistant">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-jovi.webp" alt="Jovi Green" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
                ...
                {" "}
                <span className="cd-email-line">
                  <a className="cd-email" href="mailto:jovi@creditdanny.com">
                    {"jovi@creditdanny.com"}
                  </a>
                </span>
                {" "}
                <p className="cd-role">
          ...
          <div className="cd-people cd-people--row">
            <div className="cd-person cd-person--management">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-eric.webp" alt="Eric Shaatal" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
            ...
            <div className="cd-person cd-person--management">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-teddy.webp" alt="Teddy Martinez" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
          ...
          <div className="cd-people cd-people--row">
            <div className="cd-person cd-person--team">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-derrick.webp" alt="Derrick Gradijan" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
            ...
            <div className="cd-person cd-person--team">
              <div className="cd-photo">
                {" "}
                <img src="/assets/img/team-melissa.webp" alt="Melissa Gross" loading="lazy" decoding="async" />
                {" "}
              </div>
              <div className="cd-person-text">
                <h3 className="cd-name">
                ...
                <p className="cd-role">
                  {"Marketing Director & Credit Specialist"}
                </p>
              </div>
            </div>
          </div>
